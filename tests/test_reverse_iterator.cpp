...
int main() {
...

	{
		...
		std::cout << "[ Test " << ++n << " ] (rit_begin == rit_begin - 1) " << (rit_begin == rit_begin - 1) << std::endl;
		std::cout << "[ Test " << ++n << " ] (rit_begin == rit_begin) " << (rit_begin == rit_begin) << std::endl;
		std::cout << "[ Test " << ++n << " ] (rit_begin == rit_begin + 1) " << (rit_begin == rit_begin + 1) << std::endl;
		std::cout << "[ Test " << ++n << " ] (rit_begin != rit_begin - 1) " << (rit_begin != rit_begin - 1) << std::endl;
		std::cout << "[ Test " << ++n << " ] (rit_begin != rit_begin) " << (rit_begin != rit_begin) << std::endl;
		std::cout << "[ Test " << ++n << " ] (rit_begin != rit_begin + 1) " << (rit_begin != rit_begin + 1) << std::endl;
		...
		std::cout << "[ Test " << ++n << " ] (rit_begin >= rit_begin + 1) " << (rit_begin >= rit_begin + 1) << std::endl;
		std::cout << "[ Test " << ++n << " ] (rit_begin == rit_begin) " << (rit_begin == rit_begin) << std::endl;
		std::cout << "[ Test " << ++n << " ] ((rit_begin + 10) == rit_begin) " << ((rit_begin + 10) == rit_begin) << std::endl;
		std::cout << "[ Test " << ++n << " ] ((rit_begin + 10) != rit_begin) " << ((rit_begin + 10) != rit_begin) << std::endl;
		std::cout << "[ Test " << ++n << " ] ((rit_begin + 10) < rit_begin)  " << ((rit_begin + 10) < rit_begin) << std::endl;
		std::cout << "[ Test " << ++n << " ] ((rit_begin + 10) > rit_begin)  " << ((rit_begin + 10) > rit_begin) << std::endl;
		std::cout << "[ Test " << ++n << " ] ((rit_begin + 10) <= rit_begin) " << ((rit_begin + 10) <= rit_begin) << std::endl;
